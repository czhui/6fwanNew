...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-10">
    <h2>{!!trans('admin/notice.title')!!}</h2>
    <ol class="breadcrumb">
      <li>
          <a href="{{url('admin/dash')}}">{!!trans('admin/breadcrumb.home')!!}</a>
      </li>
      <li class="active">
          <strong>{!!trans('admin/breadcrumb.notice.list')!!}</strong>
      </li>
    </ol>
  </div>
</div>
<div class="wrapper wrapper-content  animated fadeInRight">
  <div class="row">
    ...
    <div class="col-lg-6">
      <div class="ibox animated fadeInRightBig">
        <div class="ibox-title">
            <h5>{!!trans('admin/notice.desc')!!}</h5>
        </div>
        <div class="ibox-content">
          <div class="dd" id="nestable">
              <ol class="dd-list">
                {!!$noticePreseter->noticeNestable($notices)!!}
              </ol>
          </div>
        </div>
      </div>
    ...
    <div class="col-lg-6 menuBox">
        {!!$noticePreseter->canCreateNotice()!!}
    </div>
  </div>
</div>
@endsection
...
<script src="{{asset('admin/js/notice/notice.js')}}"></script>
