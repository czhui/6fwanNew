...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-10">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <strong>{!!trans('admin/breadcrumb.help.edit')!!}</strong>
        </li>
    </ol>
  </div>
</div>
    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          <form method="post" action="{{url('admin/help/'.$help->id)}}" class="form-horizontal">
            {{csrf_field()}}
            {{method_field('PUT')}}
            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="name" value="{{old('name',$help->name) }}" placeholder="{{trans('admin/help.model.name')}}"> 
                @if ($errors->has('name'))
            ...
            <div class="form-group{{ $errors->has('sort') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="sort" value="{{old('sort',$help->sort)}}" placeholder="{{trans('admin/help.model.sort')}}"> 
                @if ($errors->has('sort'))
            ...
            <div class="form-group{{ $errors->has('contents') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <textarea name="contents" id="" cols="30" rows="10" class="summernote click2edit">{{old('contents',$help->contents)}}</textarea>
              </div>
            </div>
