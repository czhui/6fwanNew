...
<head>
  ...
  <link href="{{asset('vendors/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css')}}" rel="stylesheet">
  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
      <div class="row border-bottom">
        <nav class="navbar navbar-static-top  " role="navigation" style="margin-bottom: 0">
          <div class="navbar-header">
              ...
              <form role="search" class="games navbar-form-custom" action="search_results.html">
                  <!-- <div class="form-group">
                      <input type="text" placeholder="Search for something..." class="form-control" name="top-search" id="top-search">
                  </div> -->
                  <select name="top-search" id="top-search" class="form-control input-sm">
                      <option value="10">六方广东麻将</option>
                      <option value="25">六方广东麻将2</option>
                  </select>
              </form>
          </div>
      ...
      <div class="footer">
          ...
          <div>
              <strong>Copyright</strong> 6方管理后台&copy; http://www.6fwan.com
          </div> -->
      </div>
